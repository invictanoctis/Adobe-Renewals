...
def load_excel(interface, button_name) -> None:
    """
    The loading and parsing function that is triggered once an Excel button from ui.UserInterface is pressed

    Args:
        interface (object): object of ui.UserInterface in ui
